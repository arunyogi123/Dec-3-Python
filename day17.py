...
# UPDATE `Student` SET `address` = 'Ghorahi' WHERE `Student`.`id` = 28;


# Updating data in database
terminal.execute("Update Student set address = 'nepal', name='bj' where id=37")
db.commit()


# delete data in database
terminal.execute("delete Student  where id=37")
db.commit()